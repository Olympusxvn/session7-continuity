...
> Paste this as the evolved system prompt (DeepSurge / Phase B).  
> Phase A original: [`PHASE_A_continuity-keeper.md`](./PHASE_A_continuity-keeper.md)  
> Changelog: [v1](../docs/changelog/PROMPT-v1-context-engineering.md) · [v2](../docs/changelog/PROMPT-v2-harness-contract.md)  
> Platform contract: [`docs/HARNESS-CONTRACT.md`](../docs/HARNESS-CONTRACT.md)
